...
|---------|----------------------|-------------|-----------------------------|---------------|---------------|---------------|
| 4.3.0  | Julien Ducret <br> Diego Petrucci | Automated: Execution: `1h 54min` Cumulative: `8h 41min`<br>Manual: `24h 50min`| `CE-517: 30min`<br> `CNSMR-2143: 2days`<br> `CNSMR-2395: 0.5day`<br> `CNSMR-2333: 30min`<br> `CNSMR-2334: 30min`<br> `MON-4916: 30min`<br> `MON-4916: 30min`<br> `MON-4964: 30min`<br> `CE-512: 3hrs`<br> `CNSMR-2363: TBD`<br> `CNSMR-2338: TBD`<br> `CNSMR-2337: TBD`<br>  | Total: **TBDh TBDmin** | 22.07.2019 | 30.07.2019 |
