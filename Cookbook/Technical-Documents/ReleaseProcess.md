...
|---------|----------------------|-------------|-----------------------------|---------------|---------------|---------------|
| 4.16.0 | Joao Pereira, Witold Skibniewski | Manual: `23h 30m` | `CNSMR-3413: 2h` <br> `REFER-138: 2h` <br> `CE-1139: 30m` <br> `CNSMR-3416: 2h` <br> `TC-65: 20h` <br> `NRX-1223: 30m` <br> `IOSP-553: 1.5h` <br> `CE-1136: 4h` <br> `COREUS-4237: 1h` <br>`AV-1466: 1h` <br> `AV-1456: 1h` | Total **35h 30m m** | 31.01.2020 | 10.02.2020 |
